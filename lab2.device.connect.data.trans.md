...
对于Arduino IDE环境的安装与基于AWS IoT开发环境的配置，请点击[这里](https://github.com/steelren/aws_iot_core_workshop/blob/master/ref1.arduino.env.md)。<br>
